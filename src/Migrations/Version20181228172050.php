 ...
 */
final class Version20181228172050 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, desc_court VARCHAR(255) NOT NULL, desc_long LONGTEXT NOT NULL, image_p VARCHAR(255) NOT NULL, image_sec1 VARCHAR(255) DEFAULT NULL, image_sec2 VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit_commande (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, categorie_id INT DEFAULT NULL, qte INT NOT NULL, prix DOUBLE PRECISION NOT NULL, INDEX IDX_47F5946EF347EFB (produit_id), INDEX IDX_47F5946EBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
